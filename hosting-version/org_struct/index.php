...
<!-- WA BUTTON END -->
                ...
                <section id="toppage" class="jumbotron text-center">
                  ...
                  <p class="desktopdetails" id="desktopdetails">(Arahkan kursor pada kotak hirarki untuk melihat lebih lengkap)</p>
...
<div style="box-sizing: border-box; font-size: 0; text-align: center; max-height: 31px; overflow: hidden; ">
<div ani="" style="display: inline-block; font-size: 12px; font-family: &quot;Futura-Bold&quot;, &quot;VP Default&quot;; color: #000000; line-height: 1.2; pointer-events: none; white-space: normal; word-wrap: normal; ">I Gusti Nyoman Budiadnyana, S.Kom., MM.</div>
</div>
</div>
</foreignObject>
<svg width="100%" height="100%">
...
<tspan xml:space="preserve">I Gusti Nyoman Budiadnyana, S.Kom., MM.</tspan>
</textPath>
</text>
</svg>
</switch>
...
<text text-anchor="middle" font-size="10px" x="50%" y="100%"/>
                      ...
                      <div class="col" id="mobile-mode-view" style="margin-top: 6pt;">
                          ...
                          <!-- ITEM BOX -->
                              ...
                              <table style="width: 100%; margin: 2%;">
                                  <tr>
                                      <th colspan="2"><h2 style="margin-top: 9pt; line-height: 90%; font-size: 20pt !important; color: #0a314b;">I Gusti Nyoman Budiadnyana S. Kom., MM.</h2></th>
                                  </tr>
                                  <tr>
       ...
       <svg id="footersvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 -50 1440 162" style="background-color:white;">
        ...
        $(document).ready(function() {
            ...
            document.getElementById("firefox_safari_filter").remove();
              ...
              if ((BrowserDetect.browser === "Safari") || (BrowserDetect.browser === "Firefox")) {
                ...
                document.getElementById('footersvg').style.minWidth = document.getElementById("orggraph").getBoundingClientRect().width + 240;
            }
        });
...
$(document).keyup(function() {
  ...
  el.style.animation = null; 
        ...
        function hoveritem(elemId) {
            ...
            document.getElementById("hovername").innerHTML = "I Gusti Nyoman Budiadnyana S. Kom., MM.";
