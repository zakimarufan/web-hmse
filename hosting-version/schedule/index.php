...
//Remove the HTML codes from the preview content
      ...
      while($row = mysqli_fetch_array($listquery)) {
        ...
        $sc_url_id_pointer = "http://testsite269.000webhostapp.com/schedule/index.php/" . $row['sch_url_id_pointer'];
...
while($row = mysqli_fetch_array($searchlistquery)) {
  ...
  $sc_search_url_id_pointer = "http://testsite269.000webhostapp.com/schedule/index.php/" . $row['sch_url_id_pointer'];
